...
import {
    useFetchReclamationsQuery, Reclamation,
...
const ListeReclamationEtudiant = () => {
  ...
  const handleDeleteReclamation = async (id: string) => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                Header: "Etudiant",
                accessor: (row: any) => row.studentId?.nom_fr || "",
                disableFilters: true,
                filterable: true,
            },
            {
 ...
 {actionAuthorization("/reclamation-etudiant/single-reclamation-etudiant",user?.permissions!)?
              ...
              {actionAuthorization("/reclamation-etudiant/edit-reclamation-etudiant",user?.permissions!)?

              <li>
                <Link
                  to="/reclamation-etudiant/edit-reclamation-etudiant"
              ...
              {actionAuthorization("/reclamation-etudiant/supprimer-reclamation-etudiant",user?.permissions!)?
