            ...
            <div className="page-content">
                <Container fluid={true}>
                        ...
                        <Col xxl={12}>
                            <Card className="text-center bg-primary border-0 mb-0">
                                <Card.Body className="p-5">
                                    <h4 className="text-white">Rechercher les nouvelles actualié</h4>
                        ...
                        <Col xxl={6} md={10} className="mx-auto">
                            <form action="#!" className="mt-n4">
                                <div className="seller-search-box position-relative">
                                    ...
                                    <Button variant='soft-danger' className="fw-normal position-absolute rounded-pill"><i className="bi bi-search"></i></Button>
                                </div>
                            </form>
                        </Col>
                    </Row>
                    ...
                    <Row className="mb-4 justify-content-between">
                        <Col xxl={2} sm={6}>
                            <Button onClick={() => tog_AddSellerModals()} variant='success' data-bs-toggle="modal" data-bs-target="#createModal">Ajouter Actualité</Button>
                        </Col>
                        <Col xxl={2} sm={6}>
                            ...
                            {/* <Card>
                              ...
                              <Card>
                                <Card.Body>
                                    ...
                                    <h6 className="card-subtitle font-14 text-muted">{item.stock}</h6>
                                </Card.Body>
                                <img className="img-fluid" src={item.companyLogo} alt="Card cap" />
                                <Card.Body>
                                ...
                                <div className="card-footer mt-4 hstack gap-2">
                                    <Link to = "/DetailsActualite" state={item} className="card-link link-secondary"><Button variant='soft-secondary' className="w-100">Voir plus<i className="bi bi-plus-circle-fill ms-1 align-middle lh-1"></i></Button> </Link>
                                    <Link to={item.webUrl} className="card-link link-success"><Button variant='soft-primary' className="w-100"> Lien<i className="bi bi-arrow-right-circle-fill align-middle ms-1 lh-1"></i> </Button></Link>
                                </div>
                            </Card>
                        </Col>))}
                    </Row>
